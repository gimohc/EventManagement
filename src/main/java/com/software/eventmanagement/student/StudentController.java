...
public class StudentController {
    ...
    public ResponseEntity<?> enrollInEvent(@PathVariable Long eventId,
                                           @CookieValue(value = "studentAuthenticationToken") String studentId) {
    ...
    public ResponseEntity<?> rateEvent(@PathVariable Long eventId,
                                       @CookieValue(value = "studentAuthenticationToken") String studentId,
    ...
    public ResponseEntity<?> saveFeedback(@PathVariable Long eventId,
                                          @CookieValue(value = "studentAuthenticationToken") String studentId,
